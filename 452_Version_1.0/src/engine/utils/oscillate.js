...
class OscillatePosition extends Oscillate {
    constructor(xDelta, yDelta, freq, duration) {
        super(yDelta, freq, duration);
        this.xMag = xDelta;
    }
    getNext() {
        this.mNumCyclesLeft--;
        ...
        return ([v * this.xMag, v * this.mMag]);
    }
}

export default {Oscillate, OscillatePosition}